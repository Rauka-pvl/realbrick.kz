        ...
        <div class="grid grid-cols-1 items-stretch justify-center gap-5 lg:grid-cols-[400px_400px]">
          <div class="mx-auto flex h-full w-full max-w-[400px] min-h-[240px] flex-col rounded-3xl border border-gold/35 bg-nearblack/75 p-6 backdrop-blur-sm sm:min-h-[252px] sm:p-7 lg:mx-0 lg:max-w-none">
            ...
            <div class="mt-7 flex items-center gap-2">
              <a href="#" aria-label="Facebook" class="social-gold-btn flex h-9 w-9 items-center justify-center rounded-full">
              ...
              <a href="#" aria-label="Instagram" class="social-gold-btn flex h-9 w-9 items-center justify-center rounded-full">
              ...
              <a href="#" aria-label="WhatsApp" class="social-gold-btn flex h-9 w-9 items-center justify-center rounded-full">
        ...
        <div class="reveal mt-12 grid gap-8 lg:grid-cols-2 lg:gap-12">
          <div class="space-y-4">
            ...
            <div class="flex gap-2 pt-2">
              <a href="#" class="flex h-10 w-10 items-center justify-center rounded-full border border-gold/40 text-gold transition hover:bg-gold/10" aria-label="Instagram">IG</a>
              ...
              <a href="#" class="flex h-10 w-10 items-center justify-center rounded-full border border-gold/40 text-gold transition hover:bg-gold/10" aria-label="WhatsApp">WA</a>
            </div>
          </div>
